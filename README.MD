...
Use `detect.py` to detect depressed users from all users.
...
Use `get_score.py` to get scores of all candidate posts. If score > 0, it is a good post to response.

### 6. Generate Icebreakers
